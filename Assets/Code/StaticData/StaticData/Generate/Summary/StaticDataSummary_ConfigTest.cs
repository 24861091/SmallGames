...
namespace StaticData
{
	...
	{
		private static void Read(XmlNode node ,out StaticData.ConfigTest obj)
		{
			obj = null;
			...
			if (node != null)
			{
				...
				if(obj == null)
				{
					obj = new StaticData.ConfigTest();
				}
				child = XmlSerializerUtility.GetChildrenNode(node, "a");
				if(child == null)
				{
					obj.a = 0;
					StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 a 的XML数据不存在. ");
				}
				else
				{
					...
					{
						obj.a = 0;
						StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 a 的XML数据里面是空的,没有写数据.  ");
					}
					else
					{
						if(!System.Int32.TryParse(innerText, out obj.a))
						{
							StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 a 的数据格式不对. ");
						}
					}
				}
				...
				{
					obj.b = "";
					StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 b 的XML数据不存在. ");
				}
				else
				{
					innerText = XmlSerializerUtility.GetInnerText(child);
				...
				{
					obj.c = 0;
					StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 c 的XML数据不存在. ");
				}
				else
				{
					innerText = XmlSerializerUtility.GetInnerText(child);
					...
					{
						obj.c = 0;
						StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 c 的XML数据里面是空的,没有写数据.  ");
					}
					else
					{
						if(!System.Int64.TryParse(innerText, out obj.c))
						{
							StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 c 的数据格式不对. ");
						}
					}
				}
				...
				if(child == null)
				{
					...
					StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 platform 的XML数据不存在. ");
				}
				else
				{
					innerText = XmlSerializerUtility.GetInnerText(child);
					...
					{
						obj.platform = default(UnityEngine.RuntimePlatform);
						StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 platform 的XML数据里面是空的,没有写数据.  ");
					}
					else
					{
						if (!System.Enum.TryParse<UnityEngine.RuntimePlatform>(XmlSerializerUtility.GetInnerText(child), out obj.platform))
						{
							StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 platform 的数据格式不对.  ");
						}
					}
				}
				...
				if(child == null)
				{
					...
					StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 v3 的XML数据不存在. ");
				}
				else
				{
					innerText = XmlSerializerUtility.GetInnerText(child);
					...
					{
						obj.v3 = default(UnityEngine.Vector3);
						StaticDataUtility.LogDesinerError("类型为StaticData.ConfigTest 的字段 v3 的XML数据里面是空的,没有写数据.  ");
					}
					else
					{
		...
		private static void Read(BinaryFileReader reader ,out StaticData.ConfigTest obj)
		{
			obj = null;
		...
		private static void Write(XmlDocument doc, XmlNode father,StaticData.ConfigTest obj, string label = "")
		{
