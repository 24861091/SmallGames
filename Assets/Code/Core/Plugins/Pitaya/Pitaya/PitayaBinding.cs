...
namespace Pitaya
{
    ...
    public static class PitayaBinding
    {
        ...
        private static PitayaLogLevel _currentLogLevel = PitayaLogLevel.Error;
        ...
        public static void Request(IntPtr client, string route, byte[] msg, uint reqtId, int timeout)
        {
            ...
            if (msg != null)
                length = msg.Length;
            Debug.Log($"route = {route} msg = {msg} length = {length} reqtId = {reqtId} timeout = {timeout}");
        ...
        private static PitayaError CreatePitayaError(PitayaBindingError errorBinding, PitayaSerializer serializer)
        {
            ...
            object code = "";
            json.TryGetValue("code", out code);
            object msg = "";
            json.TryGetValue("msg", out msg);
            ...
            return new PitayaError(code.ToString(), msg.ToString(), metadata);
        }
